...
let imagesToPreload = [
  ...
  ['Base Principle Card', '../_resources/principle deck card front frame.png'],
...
function drawCardCanvas() {
  ...
  // Draw the card frame
  ctx.drawImage(loadedGraphics['Base Principle Card'], 0, 0, canvas.width, canvas.height);
...
function drawCardArt() {
  ...
  let outerX = 50; // start on right half of card
